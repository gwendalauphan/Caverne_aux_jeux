...
class bird:
    def __init__(self,user):
        ...
        for i in range(2,31):
            self.liste_image.append(PhotoImage(file = resource_path('Flappy_Bird/Ressources/{}.png'.format(i))))

        self.background = []                       #Import des photos du décor mis au hasard
        for k in range(6):
            self.background.append(PhotoImage(file = resource_path('Flappy_Bird/Ressources/decor{}.png'.format(k+1))))
