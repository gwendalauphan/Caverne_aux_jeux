...
class Bird:  # pylint: disable=too-many-arguments, too-many-instance-attributes, too-many-statements
    ...
    def test_press(self, _event=None):  # Fonction servant à recevoir le click du joueur
        self.play = True
    ...
    def build_game(self):  # Fonction servant au lancement du jeu (appellée à chaque restart) #Création de la map
        ...
        self.frame_main_game.create_text(
            85, 135, text=f"{int(bestplayer[1] / 100)} points", fill="white", font=("Berlin Sans FB", FONT_SIZE_MEDIUM)
        )
        ...
        self.show_time = Label(
            self.canvas_show_time, text=f"Temps: {0}", foreground="white", bg="black", font=("Berlin Sans FB", FONT_SIZE_BIG)
        )
    ...
    def wait_game(self, _event=None):  # Fonction servant à bouger l'oiseau de haut en bas dans l'attente
    ...
    def dead(self):
        ...
        if self.y_center_bird < 0:
            ...
            y_death = self.y_center_bird / 475
