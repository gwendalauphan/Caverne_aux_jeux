...
# if HOST_ENV is defined, we use it as the host
...
def push_score(pseudo, game, score_max, score, count, time, pos=[]):
    ...
    try:
        ...
        return
    msg_To_send = "add {} {} {} {} {} {} {}".format(
        pseudo, game, score_max, score, count, time, pos
    )  # on envois la commande pour ajouter la partie actuelle
