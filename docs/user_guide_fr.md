...
- [Téléchargement et installation](#téléchargement-et-installation)
  - [Méthode simple : Télécharger les releases](#méthode-simple--télécharger-les-releases)
  - [Note pour Windows](#note-pour-windows)
  - [Méthode avancée : Cloner le dépôt](#méthode-avancée--cloner-le-dépôt)
...
- [Lancer le jeu](#lancer-le-jeu)
  ...
  - [Mode client-serveur](#mode-client-serveur)
- [Modes de jeu](#modes-de-jeu)
- [Dépannage](#dépannage)
  - [Problèmes fréquents sous Windows](#problèmes-fréquents-sous-windows)
...
## Méthode avancée : Cloner le dépôt
...
* Prérequis :
  ...
  * Se ce n'est pas le cas, veuillez suivre ce guide : [Installation des dépendances](#installation-des-dépendances)
